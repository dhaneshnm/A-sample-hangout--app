...
<link rel="stylesheet" type="text/css" href="//goodwin.drexel.edu/isensor/apps/css/view.css" media="all">
<script type="text/javascript" src="//goodwin.drexel.edu/isensor/apps/js/view.js"></script>
<script language="JavaScript" src="//goodwin.drexel.edu/isensor/apps/js/gen_validatorv31.js" type="text/javascript"></script>
</head>
</head>
<body id="main_body" >
...
<li id="li_lastname" >
		...
		<div>
			<input id="element_2" name="age" class="element text medium" type="text" maxlength="255" value=""/> 
				...
				<input id="saveForm" class="button_text" type="button" name="submit" value="Submit"   onclick="Dosubmit();" />
		</li>
...
function Dosubmit()
{
  window.location = "http://goodwin.drexel.edu/isensor/apps/games/game4/debrief.php";
}
